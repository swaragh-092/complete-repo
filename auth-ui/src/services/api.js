...
// All routes are now uniformly under /auth on the backend.
// auth-client sets baseURL = authBaseUrl (which ends with /auth).
// No interceptor hack needed — all API paths resolve correctly.
