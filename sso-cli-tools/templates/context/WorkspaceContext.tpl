...
export function WorkspaceProvider({ children }) {
  ...
  }, [isAuthenticated{{#if REQUIRES_ORGANIZATION}}, currentOrganization{{/if}}]);
  ...
  }, [{{#if REQUIRES_ORGANIZATION}}currentOrganization, {{/if}}persistWorkspaceToStorage]);
  ...
  useEffect(() => {
    ...
    {{/if}}
  }, [isAuthenticated{{#if REQUIRES_ORGANIZATION}}, currentOrganization{{/if}}, fetchWorkspaces]);
